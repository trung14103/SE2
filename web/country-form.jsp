                        ...
                        <div class="card">
                            <div class="card-body">
                                <c:if test="${country != null}">
                                    <form action="country?command=update" method="post" id="basicform" data-parsley-validate="">
                                </c:if>
                                <c:if test="${country == null}">
                                    <form action="country?command=insert" method="post" id="basicform" data-parsley-validate="">
                                </c:if>
