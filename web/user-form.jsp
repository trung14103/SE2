                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link active" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fa fa-fw fa-user-circle"></i>User Management <span class="badge badge-success">6</span></a>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">
                                <c:if test="${users == null"}>Add New Record Form</c:if>
                                <c:if test="${users != null"}>Update Form</c:if>
                            </h5>
                            <div class="card-body">
                                ...
                                <c:if test="${users == null}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputUserName" type="text" name="users.username" value="<c:out value='${users.username}' />" data-parsley-trigger="change" required="" placeholder="Username" autocomplete="off" class="form-control">
                                        <label id="err"></label>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword">Password</label>
                                        <input id="inputPassword" type="password" placeholder="Password" required="" value="<c:out value='${users.password}' />" class="form-control">
                                        <label id="err"></label>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputAddress">Address</label>
                                        <input id="inputAddress" type="address" name="users.address" data-parsley-trigger="change" required="" value="<c:out value='${users.address}' />"  placeholder="Address" autocomplete="off" class="form-control">
                                        <label id="err"></label>
                                    </div>
                                    <!-- <div class="form-group">
