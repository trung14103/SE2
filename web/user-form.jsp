            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <c:if test="${user != null}">
                            <form action="user?command=update" method="post" id="basicform" data-parsley-validate="">
                                </c:if>
                                <c:if test="${user == null}">
                                <form action="user?command=insert" method="post" id="basicform" data-parsley-validate="">
                                    </c:if>
