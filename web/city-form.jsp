                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <c:if test="${cities == null}">
                                    ...
                                    <c:if test="${cities != null}">
                                        <input type="hidden" name="id" value="<c:out value='${cities.id}' />" />
                                    </c:if>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="inputCityName" type="text" name="cities.name" value="<c:out value='${cities.name}' />" data-parsley-trigger="change" required="" placeholder="City, Province Name" autocomplete="off" class="form-control">
                                        <label id="err"></label>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputCountryID">Country ID</label>
                                        <input id="inputCountryID" type="number" placeholder="Country ID" required="" value="<c:out value='${cities.country_id}' />" class="form-control">
                                        <label id="err"></label>
                                    </div>
